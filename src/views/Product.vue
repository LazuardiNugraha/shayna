						...
						<div class="row">
							<div class="col-lg-6">
								...
								<div class="product-thumbs">
									<carousel :margin="10" class="product-thumbs-track ps-slider">
										<div
											class="pt"
											@click="changeImage(thumbs[0])"
											:class="thumbs[0] == gambar_default ? 'active' : ''"
										>
											<img src="img/jaket3.jpg" alt="" />
										</div>
...
export default {
	...
	data() {
		return {
			gambar_default: 'img/jaket3.jpg',
			thumbs: ['img/jaket3.jpg', 'img/jaket2.jpg', 'img/jaket1.jpg'],
		};
	},
	methods: {
